...
extern const char* band_name(band_t b);
extern const char* band_name(const char* freq_mhz);
extern const char* band_freq(band_t b);
extern const char* band_freq(const char* band_name);
