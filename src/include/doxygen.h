...
/** \mainpage FLLOG Sourcecode Interactive Doxygen Documentation : 000GIT_REVISION000
 <div align="center"><img src="fldigi-psk.png" ></div>

 \section intro Introduction

  Welcome to the FLLOG Interactive Doxygen Sourcecode Documentation!
  Here you'll find information useful for developing and debugging FLLOG. 
  
  FLLOG is a logbook application for Amateur Radio use which supports the adif logbook in fldigi. <BR>
  FLLOG can act as a server to multiple clients over LAN/WAN tcpip connections and multiple fldigi / flwkey clients may connect to an FLLOG server.<BR>


  <BR>
  \section download To Download FLLOG :
  <UL>
  <LI> To pull latest source with developer access: <B> git clone ssh://<YOUR-LOGIN>\@git.code.sf.net/p/fldigi/fllog fldigi-fllog</B></LI>
  <LI> To pull latest source with developer access behind proxy/firewall: <B> git clone https://<YOUR-LOGIN>\@git.code.sf.net/p/fldigi/fllog fldigi-fllog</B></LI>
  <LI> To pull latest source with no account, read-only: <B> git clone git://git.code.sf.net/p/fldigi/fllog fldigi-fllog</B></LI>
  </UL>
  ...
  <OL>
  <LI>Download the FLLOG sourcecode as described above</LI>
  ...
  \section license License
 	...
 	FLLOG is free software; you can redistribute it and/or modify
 	it under the terms of the GNU General Public License as published by
 	the Free Software Foundation; either version 3 of the License, or
 	(at your option) any later version.
