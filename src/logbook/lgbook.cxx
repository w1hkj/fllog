...
Fl_Menu_Item menu_[] = {
 ...
 {_("Save"), 0,  (Fl_Callback*)cb_mnu_save_logbook, 0, 128, FL_NORMAL_LABEL, 0, 14, 0},
 {_("New"), 0,  (Fl_Callback*)cb_mnu_new_log, 0, 128, FL_NORMAL_LABEL, 0, 14, 0},
...
void create_logbook_dialogs() {
  { dlgLogbook = new Fl_Double_Window(584, 430, _("Logbook"));
    dlgLogbook->color((Fl_Color)FL_DARK1);
    { Fl_Menu_Bar* o = new Fl_Menu_Bar(2, 0, 109, 22);
      o->menu(menu_);
    } // Fl_Menu_Bar* o
    { editGroup = new Fl_Group(2, 23, 580, 294);
      ...
      { inpTimeOn_log = new Fl_Input2(109, 40, 40, 22, _("Time"));
      ...
      { inpDateOff_log = new Fl_DateInput(151, 40, 100, 22, _("Off Date"));
      ...
      { inpTimeOff_log = new Fl_Input2(253, 40, 40, 22, _("Time"));
      ...
      { inpCall_log = new Fl_Input2(295, 40, 100, 22, _("Call"));
      ...
      { inpName_log = new Fl_Input2(397, 40, 180, 22, _("Name"));
      ...
      { inpFreq_log = new Fl_Input2(7, 78, 100, 22, _("Freq."));
      ...
      { inpMode_log = new Fl_Input2(108, 78, 130, 22, _("Mode"));
      ...
      { inpRstR_log = new Fl_Input2(240, 78, 35, 22, _("In"));
      ...
      { inpRstS_log = new Fl_Input2(277, 78, 35, 22, _("Out"));
      ...
      { inpTX_pwr_log = new Fl_Input2(313, 78, 60, 22, _("Tx Power"));
      ...
      { Fl_DateInput* o = inpQSLrcvddate_log = new Fl_DateInput(375, 78, 100, 22, _("QSL-rcvd"));
      ...
      { Fl_DateInput* o = inpQSLsentdate_log = new Fl_DateInput(477, 78, 100, 22, _("QSL-sent"));
      ...
      { inpQth_log = new Fl_Input2(7, 117, 235, 22, _("Qth"));
      ...
      { inpState_log = new Fl_Input2(245, 117, 44, 22, _("St"));
      ...
      { inpVE_Prov_log = new Fl_Input2(292, 117, 44, 22, _("Pr"));
      ...
      { inpCountry_log = new Fl_Input2(339, 117, 154, 22, _("Country"));
      ...
      { inpLoc_log = new Fl_Input2(497, 117, 80, 22, _("Loc"));
      ...
      { inpIOTA_log = new Fl_Input2(129, 156, 80, 22, _("IOTA"));
      ...
      { inpCQZ_log = new Fl_Input2(211, 156, 80, 22, _("CQZ"));
      ...
      { inpITUZ_log = new Fl_Input2(293, 156, 80, 22, _("ITUZ"));
      ...
      { inpCONT_log = new Fl_Input2(375, 156, 100, 22, _("CONT"));
      ...
      { inpDXCC_log = new Fl_Input2(478, 156, 100, 22, _("DXCC"));
      ...
      { inpNotes_log = new Fl_Input2(8, 195, 570, 45, _("Notes"));
      ...
      { Fl_Group* o = new Fl_Group(6, 242, 453, 44);
        ...
        { inpMyXchg_log = new Fl_Input2(66, 260, 164, 22, _("Exchange Out"));
        ...
        { inpSerNoIn_log = new Fl_Input2(233, 260, 55, 22, _("Ser# in"));
        ...
        { inpXchgIn_log = new Fl_Input2(291, 260, 164, 22, _("Exchange In"));
      ...
      { Fl_Group* o = new Fl_Group(462, 242, 116, 73);
        o->box(FL_ENGRAVED_FRAME);
        { inpSearchString = new Fl_Input2(467, 260, 105, 22, _("Call Search"));
        ...
        { bSearchPrev = new Fl_Button(467, 290, 24, 22);
        ...
        { bSearchNext = new Fl_Button(548, 290, 24, 22);
    ...
    { wBrowser = new Table(2, 318, 580, 110);
