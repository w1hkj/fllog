...
void Fl_Calendar_Base::setTarget (Fl_Widget *tgt)
{
	target = tgt;
}
...
static void fl_calendar_prv_month_cb (Fl_Button *, void *b)
{
	Fl_Calendar *c = (Fl_Calendar *)b;
	c->previous_month ();
...
static void fl_calendar_nxt_month_cb (Fl_Button *, void *b)
{
	Fl_Calendar *c = (Fl_Calendar *)b;
	c->next_month ();
	c->do_callback(c, (long)0);
...
static void fl_calendar_prv_year_cb (Fl_Button *, void *b)
{
	Fl_Calendar *c = (Fl_Calendar *)b;
	c->previous_year ();
	c->do_callback(c, (long)0);
...
static void fl_calendar_nxt_year_cb (Fl_Button *, void *b)
{
	Fl_Calendar *c = (Fl_Calendar *)b;
	c->next_year ();
	c->do_callback(c, (long)0);
...
void Fl_Calendar::next_month ()
{
	Date::next_month();
	update ();
}

void Fl_Calendar::previous_year ()
{
	Date::previous_year();
	update ();
}
